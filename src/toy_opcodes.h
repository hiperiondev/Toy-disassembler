...
typedef enum TOY_OPCODES {
    ...
    TOY_OP_TYPE_DECL_removed,          // deprecated
    TOY_OP_TYPE_DECL_LONG_removed,     // deprecated
    ...
    TOY_OP_IMPORT,                     //
    TOY_OP_EXPORT_removed,             // deprecated
    ...
    TOY_OP_END_OPCODES,                // mark for end opcodes list. Not valid opcode
